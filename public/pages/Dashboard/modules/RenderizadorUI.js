/**
 * RenderizadorUI — Gestiona todas las actualizaciones del DOM en el Dashboard:
 * tarjetas de resumen, KPIs diarios, insights, estados esqueleto y utilidades de formato.
 */
class RenderizadorUI {
   ...
   * @param {object} info - Objeto de datos de insights proveniente del controlador del Dashboard.
   */
